...
export async function POST(req: Request) {
  try {
    ...
    const {tokenId, karmicEnergyAmt} = body

    // Validate input
    if (typeof tokenId !== 'number' || typeof karmicEnergyAmt !== 'number') {
    ...
    // Step 4: Write transaction to exchange karmic energy to coins and foods
